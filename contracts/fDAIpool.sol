...
contract fDAIpool is ERC20, ReentrancyGuard, Ownable {
  ...
  uint256 private rewardSpeed = 200000000000000000000000000000000000; 
  ...
  address poolTokenAddress = address(0xFf795577d9AC8bD7D90Ee22b6C1703490b6512FD); //DAI
  IERC20 public poolToken  = IERC20(poolTokenAddress); //DAI

  address aaveTokenAddress = address(0x58AD4cB396411B691A9AAb6F74545b2C5217FE6a);
