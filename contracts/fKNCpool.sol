...
contract fDAIpool is ERC20, ReentrancyGuard, Ownable {
  ...
  address aave = address(0x506B0B2CF20FAA8f38a4E2B524EE43e1f4458Cc5);
  address UniswapV2Router02 = address(0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D);

  uint256 private minRedeem = 1; 
  address WETH = address(0xd0A1E359811322d97991E03f863a0C30C2cF029C);

  address uFFYIAddress = address(0x9a8a2e2013fA0e06C69A28Fe056E6C8D7cDBB5Cc);
  IuFFYI public uFFYI  = IuFFYI(uFFYIAddress);

  address poolTokenAddress = address(0x3F80c39c0b96A0945f9F0E9f55d8A8891c5671A8); //KNC
  IERC20 public poolToken  = IERC20(poolTokenAddress); //KNC

  address aaveTokenAddress = address(0xB08EC9EdB6BD7971220FEa04644174f3EbfbDe96);
  AToken public aaveToken  = AToken(aaveTokenAddress); //aKNC


  constructor () public ERC20("wrapped Fiscus KNC", "fKNC")  {
